...
323
177
Probability of choosing an incumbent (basicos)
11
0.0
0
...
333
236
Probability of choosing a previous collaborator (basicos)
11
0.0
0
...
311
290
Probability of choosing an incumbent (clinicos)
11
0.0
1
...
343
349
Probablitity of choosing a previous collaborator (clinicos)
11
0.0
1
...
@#$#@#$#@
<experiments>
  <experiment name="exp_INGER" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles with in-team? True</metric>
    <metric>count clinicos in-link</metric>
    <enumeratedValueSet variable="layout?">
      <value value="true"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="max-downtime">
      <value value="7"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="team-size">
      <value value="14"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="hom">
      <value value="14"/>
    </enumeratedValueSet>
  ...
  <experiment name="exp_prop" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
  ...
  <experiment name="exp_inter" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="r">
